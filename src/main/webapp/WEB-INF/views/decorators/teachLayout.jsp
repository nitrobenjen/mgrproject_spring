...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/resources/style.css?ver=1">
					...
					<li ><a class="dropdown-toggle"	data-toggle="dropdown" href="#">강의스케쥴</a>
						<ul class="dropdown-menu">
							<li><a href="${pageContext.request.contextPath}/teacher/teacher101">강의
									예정</a></li>
							<li><a href="${pageContext.request.contextPath}/teacher/teacher102">강의 중</a></li>
							<li><a href="${pageContext.request.contextPath}/teacher/teacher103">강의
									종료</a></li>
						</ul></li>
					<li><a href="${pageContext.request.contextPath}/teacher/teacher201">배점관리</a></li>
