...
public class AdminStuDAOImpl implements AdminStuDAO {
	...
	@Override
	public int adminStuLoginAdd(AdminCourseVO t) {
		int result = session.insert(namespace+ ".adminStuLoginAdd",t);
		return result;
	}
	...
	@Override
	public String adminStuId() {
		String result = session.selectOne(namespace + ".adminStuId");
		return result;
	}
